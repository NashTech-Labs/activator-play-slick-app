...
class EmployeeControllerSpec extends PlaySpecification with Mockito with Results {
  ...
  "EmployeeController " should {
    ...
    "edit a employee" in new WithApplication {
      ...
      val resultAsString = contentAsString(result)
      resultAsString === """{"status":"success","data":{"name":"sky","email":"sky@knoldus.com","companyName":"knoldus","position":"Senior Consultant","id":1},"msg":"Got Employee list successfully."}"""
    }
